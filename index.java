...
String English = ("English GRADE:" + G1);
...
if (G4 >=101) {
System.out.println(Filipino + " Invalid");
}else if (G4 >=97) {
System.out.println(Filipino + " Highest Honor");
}else if (G4 >= 95) {
System.out.println(Filipino + " High Honor");
}else if (G4 >= 90) {
System.out.println(Filipino + " With Honor");
}else if (G4 >= 85) {
System.out.println(Filipino + " Excellent");
}else if (G4 >= 75) {
